...
export function CreatePostPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white md:bg-slate-50">
      {/* Header */}
      <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-slate-200/80 px-4 h-14 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-lg font-bold text-slate-900">Gönderi Oluştur</h1>
        </div>
        <button onClick={() => navigate("/home")} className="p-2 -mr-2 rounded-full hover:bg-slate-100 text-slate-600 transition-colors">
          <X className="w-5 h-5" />
        </button>
      </header>
      ...
      <main className="flex-1 w-full max-w-2xl mx-auto md:py-8 md:px-6">
        <div className="md:bg-white md:rounded-[24px] md:shadow-sm md:border md:border-slate-200/60 h-full">

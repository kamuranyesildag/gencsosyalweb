      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-1.5">
          <div className="flex items-center gap-1.5 text-[13px] sm:text-[14px]">
            <span className="font-extrabold text-slate-900 dark:text-slate-100 truncate tracking-tight">
        ...
        {isEditing ? (
          <div className="mt-2 space-y-2.5 bg-white dark:bg-slate-950 p-3 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs">
            <textarea
              className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800/60 focus:border-slate-500 rounded-xl px-3.5 py-2.5 text-[14px] sm:text-[15px] text-slate-800 dark:text-slate-100 outline-none transition-colors min-h-[80px] resize-none"
              value={editContent}
            ...
            <div className="flex justify-end gap-2">
              <Button
                ...
                className="rounded-full text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-900 px-4"
              >
                İptal
              </Button>
              <Button
          ...
          <div className="text-[14px] sm:text-[15px] text-slate-800 dark:text-slate-100 whitespace-pre-wrap leading-relaxed mt-0.5">

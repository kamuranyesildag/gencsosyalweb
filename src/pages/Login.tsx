...
export function Login() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-14rem)] items-center justify-center py-8 px-4 sm:px-6">
      ...
      >
        <Card className="p-7 sm:p-10 shadow-xl border-slate-200 dark:border-slate-800/80 rounded-3xl bg-white dark:bg-slate-950 overflow-hidden relative">
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="flex flex-col items-center text-center mb-8">
                  <div className="w-14 h-14 rounded-2xl bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-slate-100 flex items-center justify-center mb-4 border border-slate-100 dark:border-slate-800">
                    <ShieldCheck className="w-7 h-7" />
                  </div>
                  <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-slate-100 tracking-tight">İki Faktörlü Doğrulama</h1>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1.5 leading-relaxed">

    ...
    <div className="w-full flex flex-col items-center justify-center pb-12 overflow-hidden">
      ...
      <section id="nasil-calisiyor" className="w-full max-w-7xl mx-auto px-4 py-12">
        ...
        >
          ...
          <div className="bg-gray-100 rounded-2xl md:rounded-[2rem] overflow-hidden border-4 md:border-8 border-gray-800 relative z-10 shadow-2xl max-w-4xl mx-auto h-[500px] flex">
            <AnimatePresence mode="wait">
              {activeTab === 'feed' && (
                <motion.div key="feed" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="w-full flex flex-col md:flex-row bg-gray-50 h-full absolute inset-0">
                  <div className="hidden md:flex flex-col w-64 p-4 border-r border-gray-200 gap-2 h-full bg-white">
                  ...
                  <div className="flex-1 p-4 md:p-6 overflow-hidden h-full">
                    ...
                    <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 mb-4 h-full">
                      ...
                      <div className="flex gap-6 text-gray-500">
                        <div className="flex items-center gap-1.5 text-sm"><Heart className="w-4 h-4"/> 1.2B</div>
                        <div className="flex items-center gap-1.5 text-sm"><Share2 className="w-4 h-4"/> 342</div>
                        <div className="flex items-center gap-1.5 text-sm"><MessageCircle className="w-4 h-4"/> 89</div>
                      </div>
                    </div>
                  </div>
                </motion.div>
              ...
              {activeTab === 'messages' && (
                <motion.div key="msgs" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="w-full flex bg-white h-full absolute inset-0">
                  <div className="w-full md:w-80 border-r border-gray-100 flex flex-col">
                    ...
                    <div className="flex-1 overflow-hidden">
                      {[1,2,3,4].map((i) => (
                        <div key={i} className={`p-4 flex gap-3 items-center border-b border-gray-50  ${i === 1 ? 'bg-indigo-50/50' : ''}`}>
                  ...
                  <div className="hidden md:flex flex-1 flex-col bg-gray-50">
                    <div className="h-16 bg-white border-b border-gray-100 flex items-center px-6 gap-3 shadow-sm shrink-0">
                    ...
                    <div className="p-4 bg-white border-t border-gray-100 shrink-0">
                      <div className="bg-gray-100 rounded-full flex items-center px-4 py-2 gap-3">
                        <div className="flex-1 text-sm text-gray-400 py-1">Bir mesaj yaz...</div>
              ...
              {activeTab === 'profile' && (
                <motion.div key="prof" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="w-full h-full overflow-y-auto bg-white absolute inset-0">
                  <div className="h-32 bg-gradient-to-r from-purple-500 to-indigo-600 shrink-0"></div>
                  ...
                  <div className="p-4 grid grid-cols-2 gap-2">
                    <div className="bg-gray-100 h-32 rounded-xl border border-gray-200"></div>
                    <div className="bg-gray-100 h-32 rounded-xl border border-gray-200"></div>
                  </div>
                </motion.div>
              )}
      ...
      <section className="w-full max-w-7xl mx-auto py-16 px-4 text-center">
        ...
        >
          {[
            { icon: <ImageIcon className="w-6 h-6"/>, title: 'Gönderi Paylaşımı', desc: 'Metin, resim veya linkleri anında takipçilerinle paylaş.' },
      ...
      <section className="w-full max-w-7xl mx-auto py-12 px-4">
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="flex flex-col items-center justify-center text-center space-y-6 bg-white p-10 md:p-14 rounded-[2rem] border border-gray-100 shadow-sm"
        >
          <div className="text-sm font-bold tracking-widest text-gray-400 uppercase">Altyapı Sponsorumuz</div>
          <a 
            href="https://www.bilhost.com/" 
            target="_blank" 
            rel="noopener noreferrer"
            className="group relative inline-flex items-center justify-center p-4 transition-all duration-300 hover:scale-105"
          >
            <img 
              src="https://www.bilhost.com/assets/images/logo.svg" 
              alt="Bilhost Logo" 
              className="h-10 md:h-14 w-auto object-contain opacity-80 group-hover:opacity-100 transition-opacity drop-shadow-sm group-hover:drop-shadow-md"
            />
          </a>
          <p className="text-gray-500 font-medium max-w-md mx-auto text-sm md:text-base">
            Genç Sosyal'in altyapı desteği Bilhost tarafından sağlanmaktadır.
          </p>
        </motion.div>
      </section>

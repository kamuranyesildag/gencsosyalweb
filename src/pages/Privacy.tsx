        ...
        <div className="p-6 sm:p-10 text-slate-700 leading-relaxed text-sm sm:text-base space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-slate-600 dark:text-slate-400 text-sm sm:text-base">
              <li>
                <strong className="text-slate-900 dark:text-slate-100">Hesap Bilgileri:</strong> Kullanıcı adı, e-posta
                adresi, ad soyad ve isteğe bağlı profil detayları.
              </li>
              <li>
                <strong className="text-slate-900 dark:text-slate-100">İçerik ve Etkileşim:</strong> Gönderileriniz,
                yorumlarınız, projeleriniz, beğenileriniz ve mesajlarınız.
              </li>
              <li>
                <strong className="text-slate-900 dark:text-slate-100">Teknik Loglar:</strong> Güvenlik ve performans

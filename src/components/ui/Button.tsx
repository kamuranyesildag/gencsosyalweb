...
const sizeStyles: Record<ButtonSize, string> = {
  sm: 'text-xs font-semibold px-3 py-1.5 min-h-[36px] rounded-lg gap-1.5',
  md: 'text-sm font-semibold px-4 py-2 min-h-[44px] rounded-xl gap-2',
  lg: 'text-base font-semibold px-6 py-2.5 min-h-[48px] rounded-2xl gap-2.5',
  icon: 'w-11 h-11 min-h-[44px] min-w-[44px] p-0 rounded-xl justify-center',
};

      ...
      <div className="w-full flex flex-col space-y-1.5 text-left">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            className={cn(
              'w-full min-h-[44px] px-3.5 py-2.5 bg-slate-50/80 border rounded-xl text-sm text-slate-900 font-normal placeholder:text-slate-400 transition-all duration-150 ease-out',

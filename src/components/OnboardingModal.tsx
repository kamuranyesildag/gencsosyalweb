  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <motion.div
        ...
        className="bg-white rounded-3xl shadow-xl w-full max-w-lg relative z-10 overflow-hidden flex flex-col max-h-[85vh]"
      >
            ...
            {step === 2 && (
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-extrabold text-slate-900">Takip Önerileri</h2>
                    <p className="text-sm font-medium text-slate-500">İlginizi çekebilecek kişiler</p>
                  </div>
                </div>
                
                <div className="flex-1 bg-slate-50/50 border border-slate-100 rounded-2xl p-4 overflow-y-auto mb-6 min-h-[300px]">
                ...
                <div className="flex items-center gap-3 mt-auto">
                  <button
                    onClick={() => setStep(1)}
                    className="px-6 py-3.5 text-slate-500 font-bold hover:bg-slate-100 rounded-2xl transition-colors"
                  >
                    Geri
                  </button>
                  <button

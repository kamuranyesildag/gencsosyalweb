    ...
    >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-slate-500 font-normal mt-0.5">Doğrulama taleplerini incele ve onayla</p>
              </div>
            </button>

            <button
              onClick={() => onNavigateTab('reports')}
              className="flex items-start gap-3 p-4 rounded-2xl bg-slate-50/80 hover:bg-rose-50/60 border border-slate-200/70 hover:border-rose-200 text-left transition-all group"
            >
              <div className="w-10 h-10 rounded-xl bg-rose-100/80 text-rose-700 flex items-center justify-center shrink-0">
                <AlertTriangle className="w-5 h-5" />
              </div>
              <div className="min-w-0 flex-1">
                <div className="text-sm font-bold text-slate-900 group-hover:text-rose-700 flex items-center justify-between">
                  <span>Moderasyon & Raporlar</span>
                  <ArrowUpRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
                <p className="text-xs text-slate-500 font-normal mt-0.5">Şikayet edilen içerikleri ve kullanıcıları denetle</p>
              </div>
            </button>

            <button
              onClick={() => onNavigateTab('official')}
              className="flex items-start gap-3 p-4 rounded-2xl bg-slate-50/80 hover:bg-sky-50/60 border border-slate-200/70 hover:border-sky-200 text-left transition-all group"
            >
              <div className="w-10 h-10 rounded-xl bg-sky-100/80 text-sky-700 flex items-center justify-center shrink-0">
                <Megaphone className="w-5 h-5" />
              </div>
              <div className="min-w-0 flex-1">
                <div className="text-sm font-bold text-slate-900 group-hover:text-sky-700 flex items-center justify-between">
                  <span>Resmi Hesaplar</span>
                  <ArrowUpRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
                <p className="text-xs text-slate-500 font-normal mt-0.5">Kurumsal rozet ve öncelikli bildirim ayarları</p>
              </div>
            </button>

            <button
              onClick={() => onNavigateTab('autofollow')}
              className="flex items-start gap-3 p-4 rounded-2xl bg-slate-50/80 hover:bg-emerald-50/60 border border-slate-200/70 hover:border-emerald-200 text-left transition-all group"
            >
              <div className="w-10 h-10 rounded-xl bg-emerald-100/80 text-emerald-700 flex items-center justify-center shrink-0">
                <UserCheck className="w-5 h-5" />
              </div>
              <div className="min-w-0 flex-1">
                <div className="text-sm font-bold text-slate-900 group-hover:text-emerald-700 flex items-center justify-between">
                  <span>Otomatik Takip</span>
                  <ArrowUpRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
                <p className="text-xs text-slate-500 font-normal mt-0.5">Yeni kayıt olanların otomatik takip edeceği hesaplar</p>
              </div>
            </button>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-slate-500 font-normal mt-0.5">Sistem e-posta sunucusu ve bağlantı testi</p>
              </div>
            </button>

            <button
              onClick={() => onNavigateTab('audit')}
              className="flex items-start gap-3 p-4 rounded-2xl bg-slate-50/80 hover:bg-slate-100 border border-slate-200/70 text-left transition-all group"
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-slate-500 font-normal mt-0.5">Yönetici eylem geçmişi ve güvenlik logları</p>
              </div>
            </button>
          </div>
        </Card>
        ...
        <Card variant="default" padding="lg" className="space-y-4 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h3 className="text-base font-bold text-slate-900">Sistem Sağlığı</h3>
              <Badge variant="success" dot>Çalışıyor</Badge>
            </div>

            <div className="space-y-3 text-xs">
              <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 border border-slate-100">
                <span className="font-semibold text-slate-600">Veritabanı</span>
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 border border-slate-100">
                <span className="font-semibold text-slate-600">Kimlik Doğrulama</span>
                <span className="font-bold text-emerald-600 flex items-center gap-1">
      ...
      {recentVerifications.length > 0 && (
        <Card variant="default" padding="lg" className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-base font-bold text-slate-900">İnceleme Bekleyen Son Başvurular</h3>
              <p className="text-xs text-slate-500 font-medium">Kullanıcılardan gelen mavi tik onay talepleri</p>
            </div>
            <Button
              variant="ghost"
              size="sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {recentVerifications.map((v) => (
              <div
                key={v.id}
                className="p-4 rounded-2xl bg-slate-50/80 border border-slate-200/70 space-y-2 flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-slate-900 text-sm truncate">@{v.username}</span>
